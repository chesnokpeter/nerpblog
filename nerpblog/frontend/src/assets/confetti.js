function confetti(idstart) {
  ...
  */
  ...
  startButton.addEventListener('click', function(event) {
    ...
    canvas.style.left = (event.clientX - 50) + 'px'; // adjust if needed
    canvas.style.top = (event.clientY - 50) + 'px'; // adjust if needed
    document.body.appendChild(canvas);
    
    var celebrationCanvas = new CelebrationCanvas(canvas, 600, 600);
